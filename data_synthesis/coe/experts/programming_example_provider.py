...
class ProgrammingExampleProvider(BaseExpert):
    ...
    ROLE_DESCRIPTION = 'You are a Python programmer in the field of operations research and optimization. Your proficiency in utilizing third-party libraries pyomo'
...
{problem_description}
Let's analyse the problem step by step, and then give your Python code with pyomo.
